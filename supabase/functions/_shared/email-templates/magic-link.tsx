...
export const MagicLinkEmail = ({ siteName = 'Funding Pulze', confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>Click the button below to sign in to your Funding Pulze account. This link will expire shortly.</Text>
