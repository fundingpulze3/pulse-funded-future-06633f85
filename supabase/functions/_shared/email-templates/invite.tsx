...
export const InviteEmail = ({ siteName = 'Funding Pulze', siteUrl, confirmationUrl }: InviteEmailProps) => (
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          <Link href={siteUrl} style={link}><strong>Funding Pulze</strong></Link>. Click below to accept the invitation and start trading.
        </Text>
