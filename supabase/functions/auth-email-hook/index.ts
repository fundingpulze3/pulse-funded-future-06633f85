...
// Configuration
const SITE_NAME = "pulse-funded-future"
const SENDER_DOMAIN = "notify.fundingpulze.com"
const ROOT_DOMAIN = "fundingpulze.com"
const FROM_DOMAIN = "fundingpulze.com" // Domain shown in From address
const FROM_LOCAL = "support" // Local part of From address
    ...
    result = await sendLovableEmail(
      {
        ...
        from: `Funding Pulze <${FROM_LOCAL}@${FROM_DOMAIN}>`,
