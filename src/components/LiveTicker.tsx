...
const LiveTicker = () => {
  ...
  return (
    <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-muted/40 glow-border text-xs sm:text-sm text-muted-foreground mt-6 h-10 overflow-hidden max-w-[90vw]">
